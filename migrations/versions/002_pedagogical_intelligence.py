...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["parent_id"],
            ["taxonomy_nodes.id"],
            name="fk_taxonomy_nodes_parent_id_taxonomy_nodes",
            ondelete="RESTRICT",
        ),
        sa.ForeignKeyConstraint(
            ["taxonomy_id"],
            ["taxonomies.id"],
            name="fk_taxonomy_nodes_taxonomy_id_taxonomies",
            ondelete="RESTRICT",
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            name="fk_question_classifications_question_version_id_question_versions",
            ondelete="RESTRICT",
        ),
        sa.ForeignKeyConstraint(
            ["supersedes_id"],
            ["question_classifications.id"],
            name="fk_question_classifications_supersedes_id_question_classifications",
            ondelete="RESTRICT",
        ),
        sa.ForeignKeyConstraint(
            ["taxonomy_id"],
            ["taxonomies.id"],
            name="fk_question_classifications_taxonomy_id_taxonomies",
            ondelete="RESTRICT",
        ),
        sa.ForeignKeyConstraint(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["question_version_id"],
            ["question_versions.id"],
            name="fk_difficulty_estimates_question_version_id_question_versions",
            ondelete="RESTRICT",
        ),
        sa.ForeignKeyConstraint(
            ["supersedes_id"],
            ["difficulty_estimates.id"],
            name="fk_difficulty_estimates_supersedes_id_difficulty_estimates",
            ondelete="RESTRICT",
        ),
