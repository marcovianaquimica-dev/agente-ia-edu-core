...
async def create_exercise_list(
    ...
    async with session_factory() as session:
        ...
        list_obj = await service.create_list(
            ...
            institution_id=str(auth_context.institution_id) if auth_context.institution_id else None,
            created_by_external_identity=auth_context.external_user_id,
            owner_external_id=auth_context.external_user_id,
