...
class EssayPromptV4Tests(unittest.TestCase):
    def setUp(self):
        self.rubric = {
    ...
    def test_registered_and_available(self):
        self.assertIn("essay_correction_v4", available_versions())

    def test_text_offset_prompt_embeds_the_text_and_schema(self):
        artifact = get_essay_prompt("essay_correction_v4")
    ...
    def test_coverage_rules_require_localized_annotations_per_competency(self):
        ...
        self.assertIn("pelo menos 5 annotations no total", prompt)
